...
cnn1 = Sequential()
cnn1.add(
    Conv2D(filters=32, kernel_size=(3, 3), activation="elu", input_shape=INPUT_SHAPE)
)
cnn1.add(MaxPooling2D(pool_size=(2, 2)))
cnn1.add(BatchNormalization(axis=-1))
cnn1.add(Conv2D(filters=64, kernel_size=(3, 3), activation="elu"))
cnn1.add(MaxPooling2D(pool_size=(2, 2)))
cnn1.add(BatchNormalization(axis=-1))
cnn1.add(Conv2D(filters=128, kernel_size=(3, 3), activation="elu"))
cnn1.add(MaxPooling2D(pool_size=(2, 2)))
cnn1.add(Conv2D(filters=256, kernel_size=(3, 3), activation="elu"))
cnn1.add(MaxPooling2D(pool_size=(2, 2)))
cnn1.add(Flatten())
cnn1.add(Dropout(0.4))
cnn1.add(
    Dense(256, activation="elu", kernel_regularizer=tf.keras.regularizers.l2(0.002))
)
...
model_kayit_adi = "pamuk_modeli.keras"
